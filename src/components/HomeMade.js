          ...
          >
            <Box component="div" className="col-flex" sx={{ m: "2rem 0" }}>
              ...
              <Typography className="font-p" variant="p" sx={{ m: "1rem 0" }}>
                Find local food producers and connect with others who share your
                food interests.
              </Typography>
              <br />
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <Box component="div" className="col-flex" sx={{ m: "2rem 0" }}>
              ...
              <Typography className="font-p" variant="p" sx={{ m: "1rem 0" }}>
                Find inspiration in Culineer from the thousands of memeber
                adding new recipes every week.
              </Typography>
              <br />
              <Typography className="font-p" variant="p">
                Enjoy our Cook Mode feature that keeps your phone from
                hibernating while your cooking
              </Typography>
            </Box>
            <Box component="div" className="col-flex">
              <img
                style={{ height: imgDimen.height, width: imgDimen.width }}
                className="homemade-img"
                src={Homemade2}
                alt=""
              />
